...
export class MockDataService {
  ...
  private invoices: Invoice[] = [
    ...
    },
    {
      ...
      otpVerifiedAt: '04/12/2026',
      acceptedBy: 'Kumari Wickramasinghe',
    },
    {
      id: 'inv7',
      serialNumber: 'EXT-26APR-0001',
      sourceType: 'external-csv',
      isExternal: true,
      externalInvoiceNo: 'ERP-90045',
      sourceSystem: 'Legacy ERP',
      importBatchId: 'batch-apr-01',
      importedAt: '04/06/2026',
      ...
      dueDate: '04/28/2026',
      placeOfSupply: 'Imported from Legacy ERP',
      paymentTermId: 'pt1',
      debtorOfficerId: 'o1',
      debtorOfficerName: 'Ranjith Silva',
      debtorOfficerEmail: 'ranjith@acme.lk',
      modeOfPayment: 'Bank Transfer',
      description: 'Imported receivable awaiting verification',
      additionalInformation: 'Imported from ERP for visibility and portal verification.',
      lines: [
        { id: 'li10', reference: 'ERP-90045', description: 'Imported receivable summary', qty: 1, unitPrice: 625000 },
      ],
      netAmount: 625000,
      vatAmount: 112500,
      grossAmount: 737500,
    ...
    {
      id: 'inv8',
      serialNumber: 'EXT-26APR-0002',
      sourceType: 'external-manual',
      isExternal: true,
      externalInvoiceNo: 'MAN-10017',
      sourceSystem: 'Manual Entry',
      importedAt: '04/06/2026',
      verificationMode: 'visibility-only',
      customerId: 'c2',
      customerName: 'Sunrise Traders (Pvt) Ltd',
      customerTin: '765432100V',
      customerAddress: 'No 8, Kandy Road, Kiribathgoda',
      ...
      dueDate: '04/25/2026',
      placeOfSupply: 'Visibility-only external receivable',
      paymentTermId: 'pt1',
      debtorOfficerId: 'o3',
      debtorOfficerName: 'Chaminda Bandara',
      debtorOfficerEmail: 'chaminda@sunrise.lk',
      modeOfPayment: 'Bank Transfer',
      description: 'Manual imported receivable for cash visibility only',
      additionalInformation: 'This receivable was manually registered and is not yet part of CashDay issuance flow.',
      lines: [
        { id: 'li11', reference: 'MAN-10017', description: 'Visibility-only external receivable', qty: 1, unitPrice: 450000 },
      ],
      netAmount: 450000,
      vatAmount: 81000,
      grossAmount: 531000,
  ...
  submitPortalResponse(invoiceId: string, decision: 'Accepted' | 'Rejected', rejectionReason?: string): Observable<void> {
    ...
    invoice.otpVerifiedAt = invoice.otpVerifiedAt || this.today();
    invoice.acceptedBy = invoice.acceptedBy || invoice.debtorOfficerName || invoice.debtorOfficerEmail || 'Verified debtor officer';
